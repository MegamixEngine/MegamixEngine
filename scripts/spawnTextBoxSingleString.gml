/// spawnTextBoxSingleString(boxPosition, endEvent, name, name color, text, [font]);
// Version of spawnTextBox that only takes in a single string as the text.
...
return spawnTextBoxUsingArray(argument[0], argument[1], argument[2], argument[3], _parseTextIntoBlocks(argument[4], view_wview - 47, _font), _font);
